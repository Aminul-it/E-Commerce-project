...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField(
            ...
            default=True,
            help_text=ugettext_lazy('Designate whether this user should be treated activ. unselecte this instead deleting account ')
    )
...
class Profile(models.Model):
    ...
    address_1 = models.TextField(max_length=250,blank=True)
